                ...
                <div>
                  ...
                  <div className="mb-10 w-full overflow-hidden rounded">
                    <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                      {getLatestBlogForCurrentCategory?.image && (getLatestBlogForCurrentCategory.image.startsWith('http://') || getLatestBlogForCurrentCategory.image.startsWith('https://')) ? (
                        <img
                          ...
                          <div className="mr-5 lg:mb-3 xl:mb-0">
                            <div className="relative h-[60px] w-[70px] overflow-hidden rounded-md sm:h-[75px] sm:w-[85px]">
                              {item.image && (item.image.startsWith('http://') || item.image.startsWith('https://')) ? (
                                <img src={item.image} alt="Blog" className="object-cover w-full h-full" />
                              ) : (
                                <div className="flex items-center justify-center h-full bg-gray-200 dark:bg-gray-700 text-gray-500 text-xs">
                                  No Image
                                </div>
                              )}
                            </div>
